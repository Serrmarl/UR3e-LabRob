...
set(MSG_I_FLAGS "-Irobotiq_urcap_control:/home/jcab/ros_ws/src/robotiq_urcap_control/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jcab/ros_ws/src/robotiq_urcap_control/msg/Robotiq2FGripper_robot_input.msg" NAME_WE)
add_custom_target(_robotiq_urcap_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robotiq_urcap_control" "/home/jcab/ros_ws/src/robotiq_urcap_control/msg/Robotiq2FGripper_robot_input.msg" ""
)

get_filename_component(_filename "/home/jcab/ros_ws/src/robotiq_urcap_control/msg/Robotiq2FGripper_robot_output.msg" NAME_WE)
add_custom_target(_robotiq_urcap_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robotiq_urcap_control" "/home/jcab/ros_ws/src/robotiq_urcap_control/msg/Robotiq2FGripper_robot_output.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robotiq_urcap_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robotiq_urcap_control\")")
  # install generated code
  install(
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robotiq_urcap_control/.+/__init__.pyc?$"
  )
endif()
